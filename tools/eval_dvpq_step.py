...
def main():
    ...
    for seq_id in [
        ...
        # "093264_5",
        # "112983_5",
        # added for testing kitti on waymo
        # "199669_0",
        # "199669_1",
        # "199669_2",
        # "199669_3",
        ...
        if args.depth_thres > 0:
            ...
            depth_pred_names = [
                os.path.join(depth_dir, name) for name in depth_pred_names
            ]
    ...
    rq = tp_per_class_all / (
        tp_per_class_all + 0.5 * fn_per_class_all + 0.5 * fp_per_class_all + epsilon
    )
    pq = sq * rq
    spq = pq[np.logical_not(things_index)]
    tpq = pq[things_index]
